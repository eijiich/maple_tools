...
dot_image = cv2.imread(data_path+r'\BlueDot.png')
...
cv2.imwrite("target2.png", image2)
...
cv2.imwrite("target_blue.png", target)
...
cv2.imwrite("target_green.png", target)
...
cv2.imwrite("target_yellow.png", target)
...
cv2.imwrite("target_red.png", target)
...
cv2.imwrite("target_purple.png", target)
...
cv2.imwrite("target_white.png", target)
...
cv2.imwrite("target.png", target)
cv2.imwrite("target_gray.png", gray_image)
cv2.imwrite("target_binary.png", binary_image)
...
cv2.imwrite("target_binary2.png", resized_image)
